...
const dailyQuests = [
  { id: 1, task: "Complete 3 To-Do List Tasks", xp: 10, image: "./Quest.png" },
  { id: 2, task: "Organize Your Workspace", xp: 5, image: "./Quest.png" },
  { id: 3, task: "Set Priorities for the Day", xp: 8, image: "./Quest.png" },
  { id: 4, task: "Focus for 30 Minutes", xp: 7, image: "./Quest.png" },
  { id: 5, task: "Reflect on the Day's Progress", xp: 6, image: "./Quest.png" },
];

const weeklyQuests = [
  { id: 1, task: "Complete 5 Major To-Do List Tasks", xp: 20, image: "./Quest.png" },
  { id: 2, task: "Create a Weekly Plan", xp: 15, image: "./Quest.png" },
  { id: 3, task: "Stay Organized for 3 Days", xp: 12, image: "./Quest.png" },
  { id: 4, task: "Complete a Time-Management Exercise", xp: 10, image: "./Quest.png" },
  { id: 5, task: "Review and Improve a Process", xp: 15, image: "./Quest.png" },
];
  ...
  return (
    <div className="pl-2 pr-2 bg-gray-50 max-w-[320px] min-w-[320px] mx-auto" style={{ fontFamily: "Geist, sans-serif" }}>
      ...
      <div className="p-2 mt-0 mb-2 rounded-lg">
        <h2 className="text-lg font-bold">{selectedQuestType === "daily" ? "Quests" : "Quests"}</h2>
      </div>
      ...
      <div className="mb-4 mt-1 ml-[65px]">
        <button
          ...
          className={`mr-2 px-5 py-1 rounded-3xl ${selectedQuestType === "daily" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
        >
          Daily
        </button>
        <button
          onClick={() => setSelectedQuestType("weekly")}
          className={`px-5 py-1 rounded-3xl ${selectedQuestType === "weekly" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
        >
          Weekly
        </button>
      </div>
      ...
      {/* Pending Quests List */}
      <div className="grid grid-cols-1 gap-1 mb-3 ml-1">
        {pendingQuests.map((quest) => (
          ...
          >
            ...
            <div className="text-xs">
              <h3
                className={`font-semibold ${completedQuests[quest.id] ? "line-through text-gray-500" : ""}`}
              >
                {quest.task}
              </h3>
